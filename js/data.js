...
const infoList = [
    {
        ...
        stitle: '착해요',
        name: '극한직업',
        desc: '누구보다 건강하고 밝은 사회를 원하는데, 바보처럼 착한 우리 형사님들 같네?',
    ...
    },
    {
        ...
        stitle: '나빠요',
        name: '어벤져스',
        desc: '당신을 보면 어벤져스 멤버들 같다니깐? 시끌벅적 평범하지가 않아~',
        li_1:'일상생활은 지루하지?',
        li_2:'항상 자유롭고 싶지?',
    ...
    },
    {
        ...
        stitle: '착해요',
        name: '라라랜드',
        desc: '꿈을 이루고 싶은 예술가 지망생들의 러브스토리! 마치 나와 같은 사람들의 이야기?',
    ...
    },
    {
        ...
        stitle: '착한척해요',
        name: '인터스텔라',
        desc: '이번 크리스마스도 혼자 새로운 지식을 갈구하시나요? ‘23년 4개월 8일’째에요..',
    ...
    },
    {
        ...
        name: '세렌디피티',
        stitle: '나쁜척해요',
        desc: '누구보다 운명을 믿지 않으세요? 그만큼 당신은 신비로운 사람이잖아요.',
    ...
    },
    {
        ...
        stitle: '독특해',
        name: '찰리와 초콜릿 공장',
        desc: '정신없지만 몽환적인 찰리의 초콜릿 공장이 당신의 에너지와 어울릴 걸?',
    ...
    },
    {
        ...
        stitle: '뜨거워요 핫해',
        name: '해리포터와 마법사의 돌',
        desc: '신비하고 웅장한 분위기의 호그와트! 당신은 용기있고 도전을 즐기는 그리핀도르 학생?!',
    ...
    },
    {
        ...
        stitle: '정의롭넹',
        name: '레미제라블',
        desc: '이런 웅장한 영화 맘에 들지 않아요? 마치 당신같잖아!',
        li_1:'카리스마가 넘쳐흐르는 당신!',
    ...
    },
    {
        ...
        stitle: '말이 너무 많아',
        name: '나홀로 집에',
        desc: '어찌저찌 잘 헤쳐나가는 케빈같은 당신! 근데 올해 왜 이걸 보고 있죠?',
        li_1:'뭐든 적응력이 빠른 당신!',
    ...
    },
    {
        ...
        stitle: '용감해요 ',
        name: '로멘틱 홀리데이',
        desc: '누구보다 소중한 사람들을 지키고 싶은 당신. 이들의 감정변화를 지켜보는 건 어때요?',
        li_1:'차분하고 헌신적인 당신!',
        li_2:'공감을 잘해서 눈물도 많아.',
    ...
    },
    {
        ...
        stitle: '뒤에서 꼼수 부려요 ',
        name: '설국열차',
        desc: '문을 열고 세상 밖으로 나갈 수 있는 당신! 이번 크리스마스에는 좀만 참아!',
        li_1:'꽤나 용의주도한 타입이군요?',
    ...
    },
    {
        ...
        stitle: '친화력이 좋아요 ',
        name: '러브액츄얼리',
        desc: '좀 더 많은 사람들의 이야기가 궁금하지 않아? 여기 그들의 사랑이야기!',
    ...
    },
    {
        ...
        stitle: '담대하고 효율적이네요 ',
        name: '토이스토리',
        desc: '버즈처럼 대담하고 통솔력 있는 당신! 이미 이번 크리스마스도 신나있군요?!',
    ...
    },
    {
        ...
        stitle: '깨끗해요 ',
        name: '명탐정 코난',
        desc: '누구보다 논리적인 당신! 코난이 딱 어울리지 않아요?',
        li_1:'모든 건 사실 기반으로!',
    ...
    },
    {
        ...
        stitle: '승부욕이 강해요 ',
        name: '겨울왕국',
        desc: '뛰어난 실력을 가진 여왕 엘사! 이건 사실 나의 모습?!',
